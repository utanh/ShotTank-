...
unsigned char colorTankENEMY_wheel[] = { 255, 185, 15 };
unsigned char colorTankENEMY_body[] = { 238, 173, 14 };
unsigned char colorTankENEMY_head[] = { 205, 149, 12 };
...
void ENEMY::set_hdCoBan()
{
    hdCoBan.assign(r, d, 1, 3, 0);
    hdCoBan.draw_rectangle(0, 0, 7, 23, colorTankENEMY_wheel);
    hdCoBan.draw_rectangle(22, 0, 29, 23, colorTankENEMY_wheel);
    hdCoBan.draw_ellipse(14, 12, 14, 10, 0, colorTankENEMY_body);
    hdCoBan.draw_ellipse(15, 12, 14, 10, 0, colorTankENEMY_body);
    hdCoBan.draw_ellipse(14, 18, 2, 12, 0, colorTankENEMY_head);
    hdCoBan.draw_ellipse(15, 18, 2, 12, 0, colorTankENEMY_head);
}

void ENEMY::vaCham_Tuong(Object obj)
{
...
void ENEMY::vaCham_Tank(Tank& tank)
{
    if(get_tocDo() == 0)
    {
        if(tank.get_loai() != 3)
